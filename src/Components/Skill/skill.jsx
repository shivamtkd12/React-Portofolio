...
import Language from '/Users/shivamtkd12/portfolio-starter/src/img/lang.png'
    ...
    return(
        <div className="skill">
            ...
            <div className="achivement">
                <div className="circle">
                    <img src={Techno} alt="" />
                    <div className="blur e-blur1" style={{ background: "var(--purple)", left: "-45rem", top:"-10rem"}}> </div>
                    <div className="blur" style={{background:"#C1F5FF", top: '15rem', width:'21rem',height:'15rem', left:'30rem' }}></div>
